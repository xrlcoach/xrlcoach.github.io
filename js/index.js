...
function sortByPosition2Desc(e) {
    e.preventDefault();
    let sortedSquad = squad.sort(function(p1, p2) {
        if (p1.position2 == p2.position2) {
            return p1.player_name.split(' ')[1] > p2.player_name.split(' ')[1] ? 1 : -1;
